 ...
 *
 * 미해결(다음 세션): 그 실측/예보 구분이 **아직 화면에 표시되지 않는다**(risk.py 가 관측
 * 출처를 등급 밴드 텍스트로 덮어씀). 그래서 이 페이지는 "출처가 화면에 표기된다"고 주장하지
 * 않는다 — 배관을 연결하기 전까지는 그 문장을 쓰면 거짓이 된다.
 * 상세: .omc/handoffs/oneul-ui-bada-session-2026-07-13.md
 */
        ...
        <li className="pipeline-step">
          ...
          <div>
            ...
            <p>
              ...
              값이 아니라, 공개된 공공 데이터를 그대로 옮긴 값입니다.
            </p>
          </div>
        </li>
